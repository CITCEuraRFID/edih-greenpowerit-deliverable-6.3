...
# D6.3 – Software Open Source

## Introduction

This repository constitutes the **D6.3 Software Open Source Repository** of the **EDIH GreenPowerIT** project. It contains a curated selection of reusable open-source software components realised to support project activities. Components have been selected based on their suitability for public release and reusability.
...
| -------------------------- | ---------------------------------------------------------------------- | ------------------------- | ------------------------ |
| lightfm-recommender        | Train and persist LightFM recommendation models                        | Python, LightFM, pandas   | Model training           |
...
| flutter-video-player       | Playing video using media_kit | Flutter, media_kit        | Video playback           |
...
| Dataset                                                 | Description (use‑case)                                                                        | License                             |
| ------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------- |
| [OpenFoodFacts](https://world.openfoodfacts.org)        | Global food‑product database (nutrition, ingredients, …)                                      | Open Database License               |
| [MovieLens](https://grouplens.org/datasets/movielens/)  | User‑movie rating data for recommender‑system research                                        | Various (GroupLens dataset license) |
| [PASTIS](https://github.com/VSainteuf/pastis-benchmark) | Panoptic & semantic segmentation benchmark of agricultural parcels from satellite time‑series | MIT License                         |
